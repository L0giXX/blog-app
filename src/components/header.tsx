...
export default function Header() {
  return (
    <header className="mx-auto mt-8 max-w-[640px] p-4 lg:mt-32">
      <div className="flex flex-col">
        ...
        <div className="mb-14 mt-8 flex justify-center sm:justify-start">
          <a
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="mr-0 h-7 w-7 rounded-lg bg-gradient-to-r from-fuchsia-500/50 to-cyan-500/50 p-[3px] shadow-lg transition delay-100 duration-500 ease-in-out hover:scale-125 hover:from-fuchsia-500 hover:to-cyan-500 sm:mr-2"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
